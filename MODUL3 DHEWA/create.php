...
// (3) Jika sudah coba deh kalian ambil data dari form (CLUE : pakai POST)
    ...
    $query = mysqli_query($koneksi, "INSERT INTO showroom_mobil(nama_mobil, brand_mobil, warna_mobil, tipe_mobil, harga_mobil) VALUES ('$nama_mobil', '$brand_mobil', '$warna_mobil', '$tipe_mobil', '$harga_mobil')");
    ...
    // (6) Jika terdapat kesalahan, buatkan eksekusi query gagalnya 
        ...
        echo "<script>alert('Error:'. mysqli_error($query))</script>";
    }
// (7) Tutup koneksi ke database setelah selesai menggunakan database
    }else{
        echo "ini tidak menggunakan metode POST";
    }
